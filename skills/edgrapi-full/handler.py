"""
edgrapi-full skill handler — clean company financials from SEC EDGAR over the
Edgrapi REST API: get_fundamentals, get_ratios, get_company, get_filings.
...
def _http_error(e):
    ...
    if e.code == 404:
        return {
            ...
            "detail": "No SEC filer matches that ticker. Use the exact listed symbol (e.g. AAPL, BRK-B).",
            "http_status": 404,
        }
    if e.code == 429:
        return {
